...
이 문서는 현재까지 컴파일된 `나에 대한 지식`을 한 번에 보는 시작 페이지다.

## 현재 요약

- 기록상 `자유`, `인정`, `창업` 욕구가 함께 움직인다.
- 스스로를 무뚝뚝하고 감정에 쉽게 휘둘리지 않는 사람으로 이해한다.
- 실패와 좌절을 단순 손실보다 다음 성장의 재료로 해석하는 경향이 있다.
- 일과 진로에서는 게임 업계 경력, 두 번의 창업 실패, 플랫폼으로의 방향 수정이 큰 축이다.
...
3. [Self/Tensions.md](/Users/user/Documents/loglife/loglife-vault/Wiki/Self/Tensions.md)
4. [Themes/일-진로-창업.md](/Users/user/Documents/loglife/loglife-vault/Wiki/Themes/일-진로-창업.md)
5. [Timeline/전환점.md](/Users/user/Documents/loglife/loglife-vault/Wiki/Timeline/전환점.md)
