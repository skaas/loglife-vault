...
- `Inbox/Text`와 `Inbox/Telegram`에서 `TODO:`를 발견하면 `현재 할 일` 후보로 본다.
- `Inbox/Text`와 `Inbox/Telegram`에서 `[ ]`, `[]`, `- [ ]`를 발견하면 `현재 할 일` 후보로 본다.
- `Inbox/Text`와 `Inbox/Telegram`에서 `DONE:`를 발견하면 `완료 신호`로 본다.
